...
(
	...
	'account-logu' => getDefaultConfig('logu Configuration', CONFIGGROUP_SWDEV, 'logu/l0gu@dbi:Oracle:host=localhost;sid=orcl'),
	'account-www-data' => getDefaultConfig('For apache user Conf', CONFIGGROUP_SWDEV, 'logu/l0gu@dbi:Oracle:host=localhost;sid=orcl'),
	'account-root' => getDefaultConfig('root Configuration', CONFIGGROUP_SWDEV, 'logu/l0gu@dbi:Oracle:host=localhost;sid=orcl'),
